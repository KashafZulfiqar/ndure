...
<div className="container-fluid  border ">
    <div className="row">
        <div className="col-lg-4 d-flex  align-items-center">
            <p className='p1 mx-1'><Link to="next"   style={{textDecoration:"none",color:"silver",}}>Men</Link><span></span>  </p>
            <p className='p1 mx-1'><Link to="next"   style={{textDecoration:"none",color:"silver"}}>Women</Link>  <span></span></p>
            <p className='p1 mx-1'> <Link to="next"   style={{textDecoration:"none",color:"silver"}}>Kids</Link>  </p>
        </div>
