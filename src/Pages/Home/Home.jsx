                ...
                <div className="row  justify-content-center">
                  <div className="col-lg-3 "></div>
                    <div className="col-lg-5 d-flex justify-content-around align-items-center" >
                      <button className="btn2  py-2" onClick={(()=>{handleClick("Men")})} ><Link to="next"   style={{textDecoration:"none",color:"black",fontWeight:"bold"}}>MEN</Link></button>
                      <button className="btn2  py-2" onClick={(()=>{handleClick("Women")})} ><Link to="next"   style={{textDecoration:"none",color:"black",fontWeight:"bold"}}>WOMEN</Link></button>
                      <button className="btn2  py-2" onClick={(()=>{handleClick("Kid")})} ><Link to="next"   style={{textDecoration:"none",color:"black",fontWeight:"bold"}}>KID</Link></button>
                    </div>
                  <div className="col-lg-3"></div>
                </div>
              </div>
